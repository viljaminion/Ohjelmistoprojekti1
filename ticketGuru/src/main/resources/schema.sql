...
FOREIGN KEY (tickettype_id) REFERENCES tickettype(tickettypeid)
);
...
('aikuisten lippu', 20.0, null),
('lasten lippu', 10.0, null),
('opiskelijalippu', 15.0, null),
('eläkeläislippu', 15.0, null);
